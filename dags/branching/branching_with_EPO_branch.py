"""
## Toy example of using the BranchExternalPythonOperator
...
- [BranchExternalPythonOperator full list of parameters](https://registry.astronomer.io/providers/apache-airflow/versions/latest/modules/BranchExternalPythonOperator)
"""
...
@dag(
    ...
    schedule=None,
    doc_md=__doc__,
    description="BranchExternalPythonOperator",
    default_args={
        "owner": "airflow",
        "retries": 0,
    },
    render_template_as_native_obj=True,
    tags=["BranchExternalPythonOperator"],
)
def branching_with_EPO_branch():
